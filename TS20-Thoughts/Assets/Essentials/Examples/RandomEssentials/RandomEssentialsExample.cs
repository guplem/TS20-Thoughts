...
namespace Essentials.Examples.RandomEssentials
{
    public class RandomEssentialsExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //EXAMPLES: 
            randomEssentials.GetRandomBool(0.75f);
            randomEssentials.GetRandomInt(3,10);
            randomEssentials.GetRandomFloat(0.5f, 0.1f);
            randomEssentials.GetRandomVector3(0.5f, 0.1f);
            randomEssentials.GetRandomVector2(0.5f, 0.1f);
            randomEssentials.GetRandomSign(0.4f);
            randomEssentials.GetRandomBoolTrueEnsured(3, 10);
            randomEssentials.GetPseudoRandomDistributedBool(5, 0.25f);
        }
