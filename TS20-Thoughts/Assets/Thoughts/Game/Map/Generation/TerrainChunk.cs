...
public class TerrainChunk : MonoBehaviour
{
    ...
    public void Load()
    {
        ...
        mapGenerator.threadedDataRequester.RequestData(
            ...
            () => HeightMapGenerator.GenerateHeightMap(mapGenerator.mapConfiguration.chunkSize, mapGenerator.mapConfiguration.chunkSize, mapGenerator.mapConfiguration.mapRadius, mapGenerator.mapConfiguration.terrainData.heightMapSettings, sampleCenter), 
            OnHeightMapReceived
        );
    }
